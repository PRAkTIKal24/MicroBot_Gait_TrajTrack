...
% Function Name : plot_link
% 
% Pupropse: To plot the three link purcell swimmer for each iteration of simualtion.
% 
...
function [] = plot_link(x,y,theta,a1,a2,x0,y0,L,colour)
