...
function [a1c,a2c,a3c,Displacements_Current] = MinusGamma(gamma,Disp)
...
%                xlim([0 10*m]);
%                ylim([0 10]);
               plot(82:82,Disp(1,3),'r',82:82,Disp(2,3),'b');
               legend('X','Y')
               xlabel('Time Steps')
...
%                xlim([0 10*m]);
%                ylim([-10 10]);
               plot(82,radtodeg(atan2(Disp(2,1),Disp(1,1))),'g');
               xlabel('Time Steps')
               ylabel('Theta(deg)')


for t2=1:i:m
        [a1c,a2c,a3c] = Flow3(t,n,gamma); 
        ...
        for t1=1:1:4    
            ...
            if (t1<=2)   
                ...
                V = a1c(t1,3)*g1 + a1c(t1,4)*g2;

                V_LieAlForm = -1.*[0 -V(3)*dt V(1)*dt ; V(3)*dt 0 V(2)*dt ; 0 0 0 ];
