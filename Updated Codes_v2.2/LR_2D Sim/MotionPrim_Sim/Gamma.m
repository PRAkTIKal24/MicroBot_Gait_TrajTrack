...
function [a1c,a2c,a3c,Displacements_Current] = Gamma(gamma,Disp)
...
for t2=1:i:m
        ...
        for t1=1:1:5    
            ...
            if (t1<=2)   
                ...
                V_InertialFrame = a1c(t1,3)*g1 + a1c(t1,4)*g2;
...
%                xlim([0 10*m]);
%                ylim([0 10]);
               plot(0:(count-1),X,'r',0:(count-1),Y,'b');
               legend('X','Y')
               xlabel('Time Steps')
               ...
               hold on;
%                xlim([0 10*m]);
               plot(0:(count-1),aa1,'r',0:(count-1),aa2,'b');
    ...
    elseif (t1==3)
     for t4=1:i:1
        ...
        for t3=1:1:4
              ...
              V_InertialFrame = a2c(t1,3)*g1 + a2c(t1,4)*g2;
...
%                ylim([-10 10]);
    ...
    elseif(t1==5)
        ...
        for t3=1:1:4
              ...
              V_InertialFrame = a3c(t1,3)*g1 + a3c(t1,4)*g2;
